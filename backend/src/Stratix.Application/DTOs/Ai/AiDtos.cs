...
public record ProjectHealthAnalysisRequest(ProjectInfoDto Project, TaskMetricsDto Tasks, RiskMetricsDto Risks, StageMetricsDto Stages, PerformanceMetricsDto Performance);
