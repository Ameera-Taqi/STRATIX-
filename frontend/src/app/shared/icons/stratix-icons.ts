/** Lucide-style SVG path fragments (viewBox 0 0 24 24). */
export const STRATIX_ICON_PATHS: Record<string, string> = {
  search:
...
export type StratixIconName = keyof typeof STRATIX_ICON_PATHS;
